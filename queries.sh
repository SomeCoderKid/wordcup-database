...
echo "$($PSQL "SELECT name FROM teams RIGHT JOIN games ON teams.team_id = games.winner_id OR teams.team_id = opponent_id WHERE round='Eighth-Final' AND year=2014 ORDER BY name")"
